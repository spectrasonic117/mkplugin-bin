...
echo "${YELLOW}Downloading Minimessage...${RESET}"
...
# Lombok
echo "${YELLOW}Downloading Lombok...${RESET}"
...
echo "${YELLOW}Downloading Shadow-Gradle-Plugin...${RESET}"
...
echo "${YELLOW}Downloading Command-API...${RESET}"
